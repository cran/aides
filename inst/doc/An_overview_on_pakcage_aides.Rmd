...
```
    ...
    <td> 
    [![CRAN](https://img.shields.io/badge/CRAN-v1.3.2-blue.svg?logo=r&logoColor=skyblue)](https://CRAN.R-project.org/package=aides)\
    [![Date](https://img.shields.io/badge/Date-Mar.07.2024-blue.svg?Color=skyblue)](https://cran.r-project.org/package=aides/news/news.html)\
    ...
    [![Licence](https://img.shields.io/badge/Licence-GPL--3-blue.svg?logo=gnu&logoColor=skyblue)](https://www.gnu.org/licenses/gpl-3.0.en.html)    </td>
  </tr>
</table>
